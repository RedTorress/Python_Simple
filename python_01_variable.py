...
# - Python 정수형: int
# 1) 문자열(String): "Hello", 'Hi' 둘 다 가능 Java에선 " " 사용
# 2) 정수형(int): 3, -1, 0
# 3) 실수형(float): 3.14, 0.0, -2.2
# 4) 논리형(boolean): True, False 대문자만 인식함
...
# - type() 함수 : () 안의 값의 type을 확인할 때 사용 -> 엄청 많이 씀
print("=" * 200)
print(type("ABC"))
print(type(3.14))
print(type(5))
...
# 9. 동적 출력
print("=" * 200)
student_num = 20203225
student_name = "Kwh"
# 출력 예 : "조선대학교 20203225, Kwh 입니다."
print("조선대학교 20203225, Kwh 입니다.") # 하드 코딩 지양
# 1. format() - Old
