...
# - 멤버함수 : append(), extend(), insert(), remove(), index(), sorted(), 등등
# * 2차원 리스트는 표(table)과 동일한 형태

list_a = [1, 2, 3] # 3칸
list_b = [] # 0칸
list_c = ["chosun", 5, 3.14, [1, 2, 3 ]] # 4칸, [1,2,3] 은 2차원 리스트
...
# a.extend(b)
# print(a)
c = a + b # a.append(b)를 할 경우 [1, 2, 3,[3, 4, 5]] 가 출력 됨
print(c)
...
b = {"b" : 3,
     "c" : 5}
a.update(b)
print(a)    # 병합 시 중복된 key는 입력값(b)이 우선
